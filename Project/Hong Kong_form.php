...
<body>
  ...
  <img src="images/hk1.jpg" height=400px width=100% style="margin-top:3%;">
  ...
  <div class="c">
    ...
    <div class="formbox">
      <!-- form start-->
      <form action="Hong Kong_form.php" method="post">
        ...
        <input type="text" name="location" id="location" value="Hong Kong" readonly>
        ...
        <center>
          <!-- radio1 -->
          <div class="imgPackage" style="background-image: url('images/hk2.jpg');">
            <div class="package">
                Sites to Visit: Hong Kong Disneyland,Big Buddha and Lantau Island. <br>
                Duration: 2N/3D <br>
                Hotel: 4star <br>
                Price: Rs.25,660 (Per Person) <br>
                <div class="selectPack" name="selectPack" ><input type="radio" name="choosePack" id="choosePack1" value='25660'><span></span></div>
            </div>
          </div>
          <!-- radio2 -->
          <div class="imgPackage" style="background-image: url('images/hk9.jpg');">
            <div class="package">
              Sites to Visit: Hong Kong Disneyland,Big Buddha,Edward Youde Aviary and Lantau Island. <br>
              Duration: 3N/4D <br>
              Hotel: 4star <br>
              Price: Rs.38,600 (Per Person) <br>
              <div class="selectPack" name="selectPack"><input type="radio" name="choosePack" id="choosePack2" value='38600' ><span></span></div>
            </div>
          </div>
          <!-- radio3 -->
          <div class="imgPackage" style="background-image: url('images/hk11.jpg');">
            <div class="package">
              Sites to Visit: Hong Kong Disneyland,Big Buddha,Edward Youde Aviary,Victoria’s Peak,Hong Kong Wet Land Park and Lantau Island. <br>
              Duration: 4N/5D <br>
              Hotel: 4star <br>
              Price: Rs.45,000 (Per Person) <br>
              <div class="selectPack" name="selectPack" ><input type="radio" name="choosePack" id="choosePack3" value='45000' ><span></span></div>
            </div>
          </div>
        </center>
        <!-- image select end-->
