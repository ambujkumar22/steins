...
<body>
  ...
  <img src="images/Malaysia_3.jpg" height=400px width=100% style="margin-top:3%;">
  ...
  <div class="c">
    ...
    <div class="formbox">
      <!-- form start-->
      <form action="Malaysia_form.php" method="post">
        ...
        <center>
          <!-- radio1 -->
          <div class="imgPackage" style="background-image: url('images/mal1.jpg');">
            <div class="package">
                Sites to Visit: Gunung Mulu National Park,Langkawi and Kuala Lumpur. <br>
                Duration: 1N/2D <br>
                Hotel: 4star <br>
                Price: Rs.16,600 (Per Person) <br>
                <div class="selectPack" name="selectPack" ><input type="radio" name="choosePack" id="choosePack1" value='16600'><span></span></div>
            </div>
          </div>
          <!-- radio2 -->
          <div class="imgPackage" style="background-image: url('images/mal3.jpg');">
            <div class="package">
              Sites to Visit: Gunung Mulu National Park,Langkawi,Taman Negara and Kuala Lumpur. <br>
              Duration: 2N/3D <br>
              Hotel: 4star <br>
              Price: Rs.30,000 (Per Person) <br>
              <div class="selectPack" name="selectPack"><input type="radio" name="choosePack" id="choosePack2" value='30000' ><span></span></div>
            </div>
          </div>
          <!-- radio3 -->
          <div class="imgPackage" style="background-image: url('images/mal7.jpg');">
            <div class="package">
              Sites to Visit: Gunung Mulu National Park,Langkawi,Taman Negara,Cameron Highlands,Melaka and Kuala Lumpur. <br>
              Duration: 4N/5D <br>
              Hotel: 4star <br>
              Price: Rs.55,400 (Per Person) <br>
              <div class="selectPack" name="selectPack" ><input type="radio" name="choosePack" id="choosePack3" value='55400' ><span></span></div>
            </div>
          </div>
        </center>
        <!-- image select end-->
...
function func(){
  ...
  var details = document.getElementById("details");
    ...
    if (choosepack1.checked==true) {
      ...
      details.value = "Sites to Visit: Gunung Mulu National Park,Langkawi and Kuala Lumpur. <br> Duration: 1N/2D <br> Hotel: 4star <br> Price: Rs.16,600 (Per Person) <br>";

    } else if (choosepack2.checked==true) {
        calculate = parseFloat(numberPeople.value)*parseFloat(choosepack2.value);
        total.value = calculate;
        details.value = "Sites to Visit: Gunung Mulu National Park,Langkawi,Taman Negara and Kuala Lumpur. <br> Duration: 2N/3D <br> Hotel: 4star <br> Price: Rs.30,000 (Per Person) <br>";
      } else if (choosepack3.checked==true) {
          calculate = parseFloat(numberPeople.value)*parseFloat(choosepack3.value);
          total.value = calculate;
          details.value = "Sites to Visit: Gunung Mulu National Park,Langkawi,Taman Negara,Cameron Highlands,Melaka and Kuala Lumpur. <br> Duration: 4N/5D <br> Hotel: 4star <br> Price: Rs.55,400 (Per Person) <br>";
        } else {
          alert("wrong input");
        }
  }
