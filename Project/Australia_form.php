...
<body>
  ...
  <img src="images/Australia_3.jpg" height=400px width=100% style="margin-top:3%;">
  ...
  <div class="c">
    ...
    <div class="formbox">
      <!-- form start-->
      <form action="Australia_form.php" method="post">
        ...
        <input type="text" name="location" id="location" value="Australia" readonly>
        ...
        <center>
          <!-- radio1 -->
          <div class="imgPackage" style="background-image: url('images/aus5.jpg');">
            <div class="package">
                Sites to Visit: Opera House,Great Barrier Reef and Blue Mountains National Park. <br>
                Duration: 2N/3D <br>
                Hotel: 5star <br>
                Price: Rs.58,385 (Per Person) <br>
                <div class="selectPack" name="selectPack" ><input type="radio" name="choosePack" id="choosePack1" value='58385'><span></span></div>
            </div>
          </div>
          <!-- radio2 -->
          <div class="imgPackage" style="background-image: url('images/aus61.jpg');">
            <div class="package">
              Sites to Visit: Opera House,Great Barrier Reef,Blue Mountains National Park and Sky diving in Melbourne. <br>
              Duration: 3N/4D <br>
              Hotel: 5star <br>
              Price: Rs.78,538 (Per Person) <br>
              <div class="selectPack" name="selectPack"><input type="radio" name="choosePack" id="choosePack2" value='78538' ><span></span></div>
            </div>
          </div>
          <!-- radio3 -->
          <div class="imgPackage" style="background-image: url('images/aus31.jpg');">
            <div class="package">
              Sites to Visit: Opera House,Great Barrier Reef,Blue Mountains National Park,Harbor Bridge,Great Ocean Road and Sky diving in Melbourne. <br>
              Duration: 5N/6D <br>
              Hotel: 5star <br>
              Price: Rs.98,500 (Per Person) <br>
              <div class="selectPack" name="selectPack" ><input type="radio" name="choosePack" id="choosePack3" value='98500' ><span></span></div>
            </div>
          </div>
        </center>
        <!-- image select end-->
...
function func(){
  ...
  var details = document.getElementById("details");
    ...
    if (choosepack1.checked==true) {
      ...
      details.value = " Sites to Visit: Opera House,Great Barrier Reef,Blue Mountains National Park and Sky diving in Melbourne. <br> Duration: 3N/4D <br> Hotel: 5star <br> Price: Rs.78,538 (Per Person) <br>";
        ...
        details.value = "Sites to Visit: Opera House,Great Barrier Reef,Blue Mountains National Park and Sky diving in Melbourne. <br> Duration: 3N/4D <br> Hotel: 5star <br> Price: Rs.78,538 (Per Person) <br>";
          ...
          total.value = calculate;
          details.value = "Sites to Visit: Opera House,Great Barrier Reef,Blue Mountains National Park,Harbor Bridge,Great Ocean Road and Sky diving in Melbourne. <br>Duration: 5N/6D <br> Hotel: 5star <br> Price: Rs.98,500 (Per Person) <br>";
        } else {
          alert("wrong input");
        }
  }
