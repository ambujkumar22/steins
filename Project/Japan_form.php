...
<body>
  ...
  <img src="images/Japan_3.jpg" height=400px width=100% style="margin-top:3%;">
  ...
  <div class="c">
    ...
    <div class="formbox">
      <!-- form start-->
      <form action="Japan_form.php" method="post">
        ...
        <input type="text" name="location" id="location" value="Japan" readonly>
        ...
        <center>
          <!-- radio1 -->
          <div class="imgPackage" style="background-image: url('images/jap9.jpg');">
            <div class="package">
                Sites to Visit: Tokyo,Ishigaki and Mount Fuji. <br>
                Duration: 1N/2D <br>
                Hotel: 4star <br>
                Price: Rs.36,000 (Per Person) <br>
                <div class="selectPack" name="selectPack" ><input type="radio" name="choosePack" id="choosePack1" value='36000'><span></span></div>
            </div>
          </div>
          <!-- radio2 -->
          <div class="imgPackage" style="background-image: url('images/jap10.jpg');">
            <div class="package">
              Sites to Visit: Tokyo,Ishigaki,Kyoto and Mount Fuji. <br>
              Duration: 2N/3D <br>
              Hotel: 4star <br>
              Price: Rs.50,000 (Per Person) <br>
              <div class="selectPack" name="selectPack"><input type="radio" name="choosePack" id="choosePack2" value='50000' ><span></span></div>
            </div>
          </div>
          <!-- radio3 -->
          <div class="imgPackage" style="background-image: url('images/jap12.jpg');">
            <div class="package">
              Sites to Visit: Tokyo, Ishigaki, Kyoto, Akihabara,Mount Fuji and Nara. <br>
              Duration: 3N/4D <br>
              Hotel: 4star <br>
...
function func(){
  ...
  var details = document.getElementById("details");
    ...
    if (choosepack1.checked==true) {
      ...
      details.value = "Sites to Visit: Tokyo,Ishigaki and Mount Fuji. <br>Duration: 1N/2D <br> Hotel: 4star <br> Price: Rs.36,000 (Per Person) <br>";

    } else if (choosepack2.checked==true) {
        calculate = parseFloat(numberPeople.value)*parseFloat(choosepack2.value);
        total.value = calculate;
        details.value = "Sites to Visit: Tokyo,Ishigaki,Kyoto and Mount Fuji. <br> Duration: 2N/3D <br> Hotel: 4star <br> Price: Rs.50,000 (Per Person) <br>";
      } else if (choosepack3.checked==true) {
          calculate = parseFloat(numberPeople.value)*parseFloat(choosepack3.value);
          total.value = calculate;
          details.value = "Sites to Visit: Tokyo, Ishigaki, Kyoto, Akihabara,Mount Fuji and Nara. <br> Duration: 3N/4D <br> Hotel: 4star <br> Price: Rs.57,000 (Per Person) <br>";
        } else {
          alert("wrong input");
        }
  }
