...
<body>
  ...
  <img src="images/Sin1.jpg" height=400px width=100% style="margin-top:3%;">
  ...
  <div class="c">
    ...
    <div class="formbox">
      <!-- form start-->
      <form action="Singapore_form.php" method="post">
        ...
        <input type="text" name="location" id="location" value="Singapore" readonly>
        ...
        <center>
          <!-- radio1 -->
          <div class="imgPackage" style="background-image: url('images/sin2.jpg');">
            <div class="package">
                Sites to Visit: Marina Bay Sands,Gardens by the Bay and Merlion Park. <br>
                Duration: 1N/2D <br>
                Hotel: 3.5star <br>
                Price: Rs.22,990 (Per Person) <br>
                <div class="selectPack" name="selectPack" ><input type="radio" name="choosePack" id="choosePack1" value='22990'><span></span></div>
            </div>
          </div>
          <!-- radio2 -->
          <div class="imgPackage" style="background-image: url('images/sin3.jpg');">
            <div class="package">
              Sites to Visit: Marina Bay Sands,Gardens by the Bay,Singapore Zoo and Merlion Park. <br>
              Duration: 2N/3D <br>
              Hotel: 3.5star <br>
              Price: Rs.32,900 (Per Person) <br>
              <div class="selectPack" name="selectPack"><input type="radio" name="choosePack" id="choosePack2" value='32900' ><span></span></div>
            </div>
          </div>
          <!-- radio3 -->
          <div class="imgPackage" style="background-image: url('images/sin10.jpg');">
            <div class="package">
              Sites to Visit: Marina Bay Sands,Gardens by the Bay,Singapore Zoo,Chinatown,Universal Studios Singapore and Merlion Park. <br>
              Duration: 4N/5D <br>
              Hotel: 4star <br>
              Price: Rs.53,090 (Per Person) <br>
              <div class="selectPack" name="selectPack" ><input type="radio" name="choosePack" id="choosePack3" value='53090' ><span></span></div>
            </div>
          </div>
        </center>
        <!-- image select end-->
...
function func(){
  ...
  var details = document.getElementById("details");
    ...
    if (choosepack1.checked==true) {
      ...
      details.value = "Sites to Visit: Marina Bay Sands,Gardens by the Bay and Merlion Park. <br> Duration: 1N/2D <br> Hotel: 3.5star <br> Price: Rs.22,990 (Per Person) <br>";

    } else if (choosepack2.checked==true) {
        calculate = parseFloat(numberPeople.value)*parseFloat(choosepack2.value);
        total.value = calculate;
        details.value = "Sites to Visit: Marina Bay Sands,Gardens by the Bay,Singapore Zoo and Merlion Park. <br> Duration: 2N/3D <br> Hotel: 3.5star <br> Price: Rs.32,900 (Per Person) <br>";
      } else if (choosepack3.checked==true) {
          calculate = parseFloat(numberPeople.value)*parseFloat(choosepack3.value);
          total.value = calculate;
          details.value = "Sites to Visit: Marina Bay Sands,Gardens by the Bay,Singapore Zoo,Chinatown,Universal Studios Singapore and Merlion Park. <br> Duration: 4N/5D <br> Hotel: 4star <br> Price: Rs.53,090 (Per Person) <br>";
        } else {
          alert("wrong input");
        }
  }
