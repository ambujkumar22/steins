...
<body>
  ...
  <img src="images/Mauritius_3.jpg" height=400px width=100% style="margin-top:3%;">
  ...
  <div class="c">
    ...
    <div class="formbox">
      <!-- form start-->
      <form action="Mauritius_form.php" method="post">
        <p><label>Name: </label></p>
        <input type="text" name="first_name" placeholder="Enter your first name" value="<?php echo $_SESSION['user_name']; ?>" readonly>
        ...
        <input type="text" name="location" id="location" value="Mauritius" readonly>
        ...
        <center>
          <!-- radio1 -->
          <div class="imgPackage" style="background-image: url('images/mau1.jpg');">
            <div class="package">
                Sites to Visit: Trou Aux Biches,Tamarind Waterfalls and Moka. <br>
                Duration: 1N/2D <br>
                Hotel: 4star <br>
                Price: Rs.48,000 (Per Person) <br>
                <div class="selectPack" name="selectPack" ><input type="radio" name="choosePack" id="choosePack1" value='48000'><span></span></div>
            </div>
          </div>
          <!-- radio2 -->
          <div class="imgPackage" style="background-image: url('images/mau5.jpg');">
            <div class="package">
              Sites to Visit: Trou Aux Biches,Tamarind Waterfalls,Moka and Mauritius Aquarium <br>
              Duration: 2N/3D <br>
              Hotel: 4star <br>
              Price: Rs.60,000 (Per Person) <br>
              <div class="selectPack" name="selectPack"><input type="radio" name="choosePack" id="choosePack2" value='60000' ><span></span></div>
            </div>
          </div>
          <!-- radio3 -->
          <div class="imgPackage" style="background-image: url('images/mau11.jpg');">
            <div class="package">
              Sites to Visit: Trou Aux Biches,Tamarind Waterfalls,Moka,Mauritius Aquarium,Sugar Museum and Parc Francois Leguat <br>
              Duration: 4N/5D <br>
              Hotel: 4star <br>
              Price: Rs.67,000 (Per Person) <br>
              <div class="selectPack" name="selectPack" ><input type="radio" name="choosePack" id="choosePack3" value='67000' ><span></span></div>
            </div>
          </div>
        </center>
        <!-- image select end-->
...
function func(){
  ...
  var details = document.getElementById("details");
    ...
    if (choosepack1.checked==true) {
      ...
      details.value = "Sites to Visit: Trou Aux Biches,Tamarind Waterfalls and Moka. <br> Duration: 1N/2D <br> Hotel: 4star <br>Price: Rs.48,000 (Per Person) <br>";

    } else if (choosepack2.checked==true) {
        calculate = parseFloat(numberPeople.value)*parseFloat(choosepack2.value);
        total.value = calculate;
        details.value = "Sites to Visit: Trou Aux Biches,Tamarind Waterfalls,Moka and Mauritius Aquarium <br>Duration: 2N/3D <br>Hotel: 4star <br>Price: Rs.60,000 (Per Person) <br>";
      } else if (choosepack3.checked==true) {
          calculate = parseFloat(numberPeople.value)*parseFloat(choosepack3.value);
          total.value = calculate;
          details.value = "Sites to Visit: Trou Aux Biches,Tamarind Waterfalls,Moka,Mauritius Aquarium,Sugar Museum and Parc Francois Leguat <br>Duration: 4N/5D <br>Hotel: 4star <br>Price: Rs.67,000 (Per Person) <br>";
        } else {
          alert("wrong input");
        }
  }
