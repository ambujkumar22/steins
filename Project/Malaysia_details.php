...
<div class="b">
	...
	<center>
	<table  cellspacing=17 cellpadding=17>
	<tr><td>
	<h3>DAY-1</h3>
	<p>Flight- &nbsp&nbsp&nbsp&nbsp Kolkata(2:00) to Kuala Lumpur(12:15)
		<br>
		Hotel- &nbsp&nbsp&nbsp&nbsp Ibis Styles Fraser Park
		<br>
		Sightseeing- &nbsp&nbsp&nbsp&nbsp Day At Leisure
		<br>
		Meal- &nbsp&nbsp&nbsp&nbsp Dinner
	</p></td>
		<td><h3>DAY-2</h3>
	<p><br>Hotel- &nbsp&nbsp&nbsp&nbsp Ibis Styles Fraser Park
		<br>
		Sightseeing- &nbsp&nbsp&nbsp&nbsp Full Day Sunway Lagoon
		<br>
		Meal- &nbsp&nbsp&nbsp&nbsp Breakfast & Dinner
	</p></td>

	<td rowspan=2><h3>DAY-5</h3>
	<p>Flight- &nbsp&nbsp&nbsp&nbsp Kuala Lumpur(20:45) to Kolkata(5:05)
		<br>
		Hotel- &nbsp&nbsp&nbsp&nbsp Ibis Styles Fraser Park
		<br>
		Sightseeing- &nbsp&nbsp&nbsp&nbsp No Sightseeing
		<br>
	...
	<p><br>
		Hotel- &nbsp&nbsp&nbsp&nbsp Ibis Styles Fraser Park
		<br>
		Sightseeing- &nbsp&nbsp&nbsp&nbsp Half Day City Tour of Kuala Lumpur
		<br>
		Meal- &nbsp&nbsp&nbsp&nbsp Breakfast & Dinner
	</p></td>
		<td><h3>DAY-4</h3>
	<p><br>
		Hotel- &nbsp&nbsp&nbsp&nbsp Ibis Styles Fraser Park
		<br>
		Sightseeing- &nbsp&nbsp&nbsp&nbsp Half Day City Tour of Singapore
		<br>
		Meal- &nbsp&nbsp&nbsp&nbsp breakfast & Dinner
	</p></td>
	</tr>
