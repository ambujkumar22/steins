...
<body>
  ...
  <img src="images/Thai1.jpg" height=400px width=100% style="margin-top:3%;">
  ...
  <div class="c">
    ...
    <div class="formbox">
      <!-- form start-->
      <form action="Thailand_form.php" method="post">
        ...
        <input type="text" name="location" id="location" value="Thailand" readonly>
        ...
        <center>
          <!-- radio1 -->
          <div class="imgPackage" style="background-image: url('images/thi7.jpg');">
            <div class="package">
                Sites to Visit: Mu Ko Chang National Park,Ayutthaya and Mae Hong Son. <br>
                Duration: 2N/3D <br>
                Hotel: 4star <br>
                Price: Rs.21,990 (Per Person) <br>
                <div class="selectPack" name="selectPack" ><input type="radio" name="choosePack" id="choosePack1" value='21990'><span></span></div>
            </div>
          </div>
          <!-- radio2 -->
          <div class="imgPackage" style="background-image: url('images/thi3.jpg');">
            <div class="package">
              Sites to Visit: Mu Ko Chang National Park,Ayutthaya,Phuket and Mae Hong Son. <br>
              Duration: 3N/4D <br>
              Hotel: 4star <br>
              Price: Rs.38,800 (Per Person) <br>
              <div class="selectPack" name="selectPack"><input type="radio" name="choosePack" id="choosePack2" value='38800' ><span></span></div>
            </div>
          </div>
          <!-- radio3 -->
          <div class="imgPackage" style="background-image: url('images/thi10.jpg');">
            <div class="package">
              Sites to Visit: Mu Ko Chang National Park, Ayutthaya, Phuket,Koh Tao,Island Hopping and Mae Hong Son. <br>
              Duration: 5N/6D <br>
              Hotel: 4star <br>
              Price: Rs.57,000 (Per Person) <br>
              <div class="selectPack" name="selectPack" ><input type="radio" name="choosePack" id="choosePack3" value='57000' ><span></span></div>
            </div>
          </div>
        </center>
        <!-- image select end-->
...
function func(){
  ...
  var details = document.getElementById("details");
    ...
    if (choosepack1.checked==true) {
      ...
      details.value = "Sites to Visit: Mu Ko Chang National Park,Ayutthaya and Mae Hong Son. <br> Duration: 2N/3D <br> Hotel: 4star <br> Price: Rs.21,990 (Per Person) <br>";

    } else if (choosepack2.checked==true) {
        calculate = parseFloat(numberPeople.value)*parseFloat(choosepack2.value);
        total.value = calculate;
        details.value = "Sites to Visit: Mu Ko Chang National Park,Ayutthaya,Phuket,Koh Tao,Island Hopping and Mae Hong Son. <br> Duration: 3N/4D <br> Hotel: 4star <br> Price: Rs.38,800 (Per Person) <br>";
      } else if (choosepack3.checked==true) {
          calculate = parseFloat(numberPeople.value)*parseFloat(choosepack3.value);
          total.value = calculate;
          details.value = "Sites to Visit: Trou Aux Biches,Tamarind Waterfalls,Moka,Mauritius Aquarium,Sugar Museum and Parc Francois Leguat <br> Duration: 5N/6D <br> Hotel: 4star <br> Price: Rs.57,000 (Per Person) <br>";
        } else {
          alert("wrong input");
        }
  }
